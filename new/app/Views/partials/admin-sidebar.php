...
$links = [
    ['url' => 'admin/dashboard', 'label' => 'Dashboard', 'match' => '/admin/dashboard', 'icon' => 'grid'],
    ['url' => 'admin/content/home', 'label' => 'Home page', 'match' => '/admin/content/home', 'icon' => 'home'],
    ['url' => 'admin/content/about', 'label' => 'About page', 'match' => '/admin/content/about', 'icon' => 'info'],
    ['url' => 'admin/services', 'label' => 'Services', 'match' => '/admin/services', 'icon' => 'box'],
    ['url' => 'admin/blog', 'label' => 'Blog', 'match' => '/admin/blog', 'icon' => 'article'],
    ['url' => 'admin/quotes', 'label' => 'Quotes', 'match' => '/admin/quotes', 'icon' => 'quote'],
    ['url' => 'admin/contacts', 'label' => 'Contacts', 'match' => '/admin/contacts', 'icon' => 'mail'],
    ['url' => 'admin/media', 'label' => 'Media library', 'match' => '/admin/media', 'icon' => 'image'],
];
if (Auth::hasRole('super_admin')) {
    $links[] = ['url' => 'admin/settings/email', 'label' => 'Email settings', 'match' => '/admin/settings/email', 'icon' => 'settings'];
}
$icons = [
...
<aside class="admin-sidebar">
  <div class="admin-sidebar__brand">
    ...
    <p class="text-xs text-slate-500 mt-0.5">Content management</p>
  </div>

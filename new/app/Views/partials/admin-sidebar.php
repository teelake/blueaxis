...
$links = [
    ...
    ['url' => 'admin/content/footer', 'label' => 'Footer', 'match' => '/admin/content/footer', 'icon' => 'footer', 'permission' => Permission::CONTENT],
    ...
    ['url' => 'admin/settings/site', 'label' => 'Site branding', 'match' => '/admin/settings/site', 'icon' => 'branding', 'permission' => Permission::SETTINGS_SITE],
    ['url' => 'admin/settings/social', 'label' => 'Social media', 'match' => '/admin/settings/social', 'icon' => 'social', 'permission' => Permission::SETTINGS_SITE],
...
$icons = [
    ...
    'footer' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M4 5h16M4 12h16M4 19h10"/>',
    ...
    'branding' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>',
    'social' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M17 8h2a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2v-9a2 2 0 012-2h2m3-4h4m-4 0a2 2 0 104 0m-4 0a2 2 0 114 0M12 16v4m-4-2h8"/>',
